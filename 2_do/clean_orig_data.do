...
/*
Why do country company year not uniquely identify observations in the master data??
See e.g., Australia BHP GROUP LTD
Both named BHP GROUP LTD but one should be called BHP GROUP PLC based on full_dataset_tabular.csv

What to do with companies that aren't assigned to countries?
Same thing as above, companies are not missing data in full_dataset_tabular.csv
*/
...
*Reclassify islands as part of UK 
replace country = "United Kingdom" if country == "Bermuda"
replace country = "United Kingdom" if country == "British Virgin Islands"
replace country = "United Kingdom" if country == "Cayman Islands"
replace country = "United Kingdom" if country == "Gibraltar"
replace country = "United Kingdom" if country == "Isle of Man"
replace country = "United Kingdom" if country == "Jersey"
