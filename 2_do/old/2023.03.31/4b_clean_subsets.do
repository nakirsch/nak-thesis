...
foreach file in "bal_sub1_unagg_all.dta" "bal_sub2_unagg_neg_dropobs.dta" "bal_sub3_unagg_neg_dropfirms.dta" /// 
	...
	label var evintensity_dif "Diff in intensity"
	label var policy_dif "Diff in environmental policy level"
	label var gov_dif "Diff in government effectivenss"
	label var ln_gdp_percap_dif "Diff in natural log of GDP per capita (USD)" 
	label var ln_pop_dif "Diff in natural log of population"
