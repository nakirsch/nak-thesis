...
*use "$prepped_data/sub1_unagg_all.dta", clear 
*use "$prepped_data/sub2_unagg_neg_dropobs.dta", clear
*use "$prepped_data/sub3_unagg_neg_dropfirms.dta", clear
*use "$prepped_data/sub4_agg_all.dta", clear 
*use "$prepped_data/sub5_agg_neg_dropobs.dta", clear 
*use "$prepped_data/sub6_agg_neg_dropfirms.dta", clear
